...
# پنل مدیریت ربات تلگرام — نسخه ۳٫۳
...
5. **ارسال خودکار و زمان‌بندی‌شده:**
   - امکان زمان‌بندی برای انتشار خودکار نرخ‌ها در کانال‌ها یا گروه‌های تلگرامی شما در ساعات مشخص روز.
   - دسترسی سریع با دستورات: `/rates`, `/price`, `/gold`, `/dollar`, `/arz`.
...
<details>
<summary><b>▸ ربات پایگاه اخبار مهم کشور ایران (Iran News Publisher)</b></summary>

<div dir="rtl">

**امکانات ربات خبرخوان و اخبار مهم:**

1. **جمع‌آوری لحظه‌ای سرخط خبرها:**
   - فید لحظه‌ای مهم‌ترین و داغ‌ترین اخبار کشور ایران از معتبرترین خبرگزاری‌های رسمی.
   - خلاصه‌سازی متن خبر و درج برچسب خبرگزاری و زمان انتشار.
2. **دسته‌بندی‌های موضوعی:**
   - خبرهای فوری و مهم، اخبار سیاسی و دولت، اقتصاد و بازار، جامعه و حوادث، ورزش و فوتبال، علم و فناوری.
3. **تعاملی و دوطرفه:**
   - نمایش سرخط‌های برتر با دکمه‌های شیشه‌ای ورق‌زدن خبرها همراه با دکمه‌های «🔙 بازگشت به دسته‌بندی» و «🔙 منوی اصلی».
   - انتشار خودکار خبرهای فوری در کانال‌های متصل با دستورات `/news` و `/khabar`.
...
<details>
<summary><b>▸ بخش خبر — دسته‌بندی، زمان‌بندی و ارسال به کانال/گروه</b></summary>

<div dir="rtl">

اخبار از معتبرترین خبرگزاری‌ها (ایرنا، ایسنا، مهر، تسنیم، تابناک) جمع‌آوری و **با کلیدواژه به دسته‌های فوری، سیاسی، اقتصادی، ورزشی و فناوری تفکیک می‌شود**؛ هر دسته فقط اخبار همان موضوع را نشان می‌دهد.

1. کاربران داخل ربات با دکمه «📰 اخبار مهم کشور ایران» یا `/news` هر دسته را جداگانه می‌بینند.
2. در **تنظیمات ← بخش خبر** (یا `/admin` ← 📰 مدیریت اخبار در تلگرام):
   ...
   - **زمان‌بندی:** ارسال خودکار را فعال، دسته و فاصله (۱۰ تا ۱۴۴۰ دقیقه) را تعیین کنید؛ اجرا در سرور (cron) انجام می‌شود و پنل لازم نیست باز بماند. خبرهای تکراری دوباره ارسال نمی‌شوند و اگر خبر تازه‌ای نباشد، ارسال انجام نمی‌شود.
...
1. **افزودن پنل** را بزنید و نوع را انتخاب کنید: Marzban، Marzneshin، انبار دستی (Stock) و…
...
| 📰 بخش اخبار داخل ربات | دکمه «📰 اخبار مهم کشور ایران» در منوی ربات یا دستور `/news` | همه کاربران |
...
<details>
<summary><b>▸ مدیریت کامل از خود تلگرام (بدون پنل وب) — اخبار، حذف فوروارد و دکمه‌ها</b></summary>
...
| دکمه | امکانات |
|------|---------|
| 📰 **مدیریت اخبار** | ارسال فوری خبر هر دسته (فوری، سیاسی، اقتصادی، **ورزشی**، فناوری یا ترکیب همه) به کانال/گروه‌های ثبت‌شده؛ روشن/خاموش کردن ارسال خودکار؛ انتخاب دسته و فاصله زمان‌بندی (۱۵ دقیقه تا ۲۴ ساعت)؛ ثبت/ویرایش مقصدها |
...
| `/admin` یا `/panel` | مدیریت | باز کردن پنل مدیریت مینی‌اپ برای ادمین |
...
| `/rates`, `/price`, `/gold` | بازار و قیمت | نرخ لحظه‌ای طلا، دلار، سکه و رمزارزها |
| `/news` یا `/khabar` | اخبار | پایگاه اخبار فوری و مهم کشور ایران |
