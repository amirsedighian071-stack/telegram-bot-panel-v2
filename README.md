...
# پنل مدیریت ربات تلگرام — نسخه ۳٫۶
...
> **نسخهٔ ۳٫۶:** تکمیل اتصال Remnawave و Rebecca و درگاه‌های TonPay، BluPal، QubePay و Tronado در فروش VPN. [راهنمای راه‌اندازی، آزمون‌ها و محدودیت‌های واقعی](docs/RELEASE-3.6.fa.md).
